...
void main() {
  ...
  //This group of tests will be where we run the majority of our integration tests
  group('Hangman Game', () {
    test(
        'Scenario: We should be at the home screen at launch and have the ability to start a new game and then the score should be 0',
        () async {
    ...
    test(
        'Scenario: Once we are at our main game screen, we should be able to guess the letter b and the game should register it as one correct letter and the score should be 5',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      ...
      final findScoreTextWidget = find.byValueKey('score-text');
      expect(await driver.getText(findScoreTextWidget), 'Score: 5');
    });

    test(
        'Scenario: After guessing the letter n, we are expecting the game to continue registering it as a correct guess and updating our progress and the score should be 15',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test(
        'Scenario: Guess an incorrect letter z, and expect for it to be added to our incorrect guesses list and the score should be 10',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test(
        'Scenario: Once I have guessed all correct letters of a word, the game should be over and I should be navigated to the Win Screen and the score should be 25',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test(
        'Scenario: After winning the game, we should be able to start a new one',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
    ...
    test(
        'Scenario: We should lose the game by incorrectly guessing 7 times in a row and the score should be -35',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test('Scenario: After losing a game, we should be able to start a new one',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final newGameBtn = find.byValueKey('new-game-btn');
      final guessLetterTextFinder = find.byValueKey('guess-letter-text');
    ...
    test(
        'Scenario: Guessing the same correct letter should return an error message',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test(
        'Scenario: Guessing the same incorrect letter should return an error message',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
    ...
    test(
        'Scenario: When guessing an character that is not alphanumeric, we expect an invalid message from the game',
        () async {
      //Here we assign variables using the keys we have placed on our widgets in our screens folder so we can use them in this test
      final findGuessingTextField = find.byValueKey('guess-textfield');
      final guessLetterBtnFinder = find.byValueKey('guess-letter-btn');
