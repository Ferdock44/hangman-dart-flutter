...
void main() {
  ...
  group("Scoring", () {
    test(
        'should give 5 points when correctly guessing the letter "b" where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('b');
    ...
    test(
        'should give -5 points when incorrectly guessing a letter where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('k');
    ...
    test(
        'should give 20 points when correctly guessing multiple("b", "a") letters where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('b');
    ...
    test(
        'should give -10 points when incorrectly guessing multiple(3) letters where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('k');
    ...
    test(
        'should give 10 points when incorrectly guessing twice and correctly guessing "b" and "a" where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('k');
    ...
    test(
        'should give 15 points when correctly guessing the letter "a" where the word is "banana"',
        () {
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      hangmanGame.guess('a');
